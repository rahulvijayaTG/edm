...
<xsl:stylesheet 
  ...
  <!-- ********************************************************************** 
   ...
   <xsl:template match = "RESPONSES" mode="content">
    ...
    <xsl:call-template name="include_javascript_select_org_contact"/>
  ...
  *********************************************************************** -->
  ...
  <!-- ********************************************************************** 
  *********************************************************************** -->
  <xsl:template name="include_javascript_select_org_contact">  
    <script>
	  
	  function details()
	  {
		document.result_form.action = "contact/controller/details.cmd";
		document.result_form.submit();
	  }
	  
	  function addNew()
	  {
		document.result_form.action = "contact/controller/addNew.cmd?IS_NEW=true";
		document.result_form.submit();
	  }
	  
	  function deleteContact()
	  {
	    var lastName = document.search_form.LAST_NAME.value;
		...
		document.result_form.action = "../../contacts/deleteContact.cmd?SEARCH_PAGE=select_org_contact&amp;SELECTED_INDEX=" + selectedIndex + "&amp;LAST_NAME=" + lastName;
		document.result_form.submit();
	  }
	  ...
	  function makeDefault()
	  {
	    var len = document.result_form.ID.length;
  		...
  		var selectedIndex = eval(i+1);
		document.result_form.action = "contact/controller/makeDefault.cmd?SELECTED_INDEX=" + selectedIndex;
		document.result_form.submit();
	  }
    </script>
  </xsl:template>	  
