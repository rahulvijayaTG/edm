...
<xsl:stylesheet 
  ...
  <!-- ********************************************************************** 
   ...
   <xsl:template match = "RESPONSES" mode="content">
    ...
    <xsl:call-template name="include_javascript_select_org"/>
  ...
  *********************************************************************** -->
  ...
  <!-- ********************************************************************** 
  *********************************************************************** -->
  <xsl:template name="include_javascript_select_org">  
    <script>
	  ...
	  function orgOverview()
	  {
	    var len = document.result_form.ID.length;
  		...
  		if(ifAnySelected(result_form)){
			...
			document.result_form.action= "org/controller/overview.cmd?SELECTED_INDEX=" + selectedIndex;
	  ...
	  function addNewOrg()
	  {
		document.result_form.action = "org/controller/addNew.cmd?IS_NEW=true";
		document.result_form.submit();
	  }
    </script>
  </xsl:template>	  
