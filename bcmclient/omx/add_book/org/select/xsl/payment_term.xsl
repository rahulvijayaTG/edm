...
<xsl:stylesheet 
  ...
  <!-- ********************************************************************** 
   ...
   <xsl:template match = "RESPONSES" mode="content">
    ...
    <xsl:call-template name="include_javascript_select_payment_term"/>
  ...
  *********************************************************************** -->
  ...
  <!-- ********************************************************************** 
  *********************************************************************** -->
  <xsl:template name="include_javascript_select_payment_term">  
    <script>
	  
  	  function details()
  	  {
  		  document.result_form.action = "payment_term/controller/details.cmd";
  		  document.result_form.submit();
  	  }
  	  
  	  function addNew()
  	  {
  		  document.result_form.action = "payment_term/controller/addNew.cmd?IS_NEW=true";
  		  document.result_form.submit();
  	  }
      
      function remove()
  	  {
  		  document.result_form.action = "payment_term/controller/remove.cmd";
  		  document.result_form.submit();
  	  }
