  ...
  *********************************************************************** -->
  <xsl:template match="ORGANIZATION" mode="edit">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	  ...
	  <input type="hidden" name="ACTIVATABLE" value="{ACTIVATABLE/@Value}"/>
	  <input type="hidden" name="DEACTIVATABLE" value="{DEACTIVATABLE/@Value}"/>
            ...
            <i2:container title="{$caption_title}" inner="yes" stretch="yes">
              ...
              <table border="0" cellpadding="0" cellspacing="5" width="100%">
                <tr><td>
                  <table border="0" cellpadding="0" cellspacing="5" width="100%">
                    <tr class="text">
					<td nowrap="nowrap"><i18n:text>Organization Name</i18n:text><xsl:text>:</xsl:text>
                ...
                <tr class="text">
                  <td nowrap="nowrap"><i18n:text>Short Name</i18n:text><xsl:text>:</xsl:text>
                    <xsl:call-template name="display_alert_mark"/>
                  </td>
                  <td nowrap="nowrap">
                  ...
                  <td nowrap="nowrap">
                    <xsl:choose>
                      <xsl:when test="PARENT_ORG_LINK">
                        <a href="org.jsp?ORG_ID={PARENT_ORG_ID/@Value}" target="appFrame"><xsl:value-of select="PARENT_ORG_LINK/ORGANIZATION/FULL_NAME/@Value"/></a>
                      </xsl:when>
                      <xsl:otherwise>
              ...
              <table border="0" cellpadding="0" cellspacing="5" width="100%">
                ...
                <tr class="text">
                  ...
                  <td nowrap="nowrap">
                    <select class="inputfieldIE" name="COUNTRY" tabIndex="" required="true" onchange="javascript:changeCountry('form')">
				...
				<!-- Contacts -->
				<tr>
				  <td nowrap="yes" width="15%" rowspan="3" valign="top">
				    <i18n:text>Default Contact:</i18n:text>
				  </td>
				  <td nowrap="yes" width="35%" rowspan="3" colspan="2" valign="top" align="left">
				    <xsl:choose>
					  <xsl:when test="../CONTACT">
					    <xsl:value-of select="../CONTACT/LAST_NAME/@Value"/>, <xsl:value-of select="../CONTACT/FIRST_NAME/@Value"/>
					  </xsl:when>
					  <xsl:otherwise>
					    <i18n:text>No default contact exist.</i18n:text>
					  </xsl:otherwise>
					</xsl:choose>
              	  </td>
                </tr>
            ...
            <table width="100%" class="tableRow1">
              <tr>
                <td valign="top">
                  <table border="0" cellpadding="0" cellspacing="5" width="100%">
                    <tr>						
                      <td nowrap="true" width="15%"><i18n:text>Organization Name</i18n:text>:</td>
                      <td nowrap="true" width="35%"><xsl:value-of select="FULL_NAME/@Value"/></td>
                    </tr>
                    <tr>
                      <td nowrap="true" ><i18n:text>Short Name</i18n:text>:</td>
                        <xsl:choose>
