...
<frameset rows="30,*" frameborder="no" border="0" bordercolor="#e6e6e6">
    <frame name="header" src=<%="addbook_header_org.jsp"+queryStr%> noresize="yes" scrolling="no"/>
    <frame name="content" src=<%="addbook_sellerEntities_content.jsp"+queryStr%> scrolling="auto"/>
