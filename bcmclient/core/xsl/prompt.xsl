...
<xsl:stylesheet 
  ...
  *********************************************************************** -->
  <xsl:template match="/">
    <html>
      <head>
        <title><i18n:text><xsl:value-of select="RESPONSES/RESPONSE/REQUEST_PARAMETERS/PAGE_TITLE/@Value"/></i18n:text></title>
...
<!--           <i2:img src="{$img}" border="0"/>
 -->
          <table><form name="form"><tr><td>
        <table>
         <xsl:apply-templates select="FIELDS/FIELD" mode="content_form"/>
        </table>
        </td></tr></form></table>         
            ...
            <tr>
              ...
              <td>
                <div style="border:1px solid #505050">
                  <button 
                          id="buttonRegular" 
                           onclick="javascript:i2uiCloseMessageBox('_cancel_')">
              ...
              <td>
                <div style="border:1px solid #505050">
                  <button 
                          id="buttonRegular" 
                           onclick="javascript:i2uiCloseMessageBox(document.form.userinput.value)">
