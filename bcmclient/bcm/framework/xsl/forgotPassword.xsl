...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:lxslt="http://xml.apache.org/xslt" xmlns:i2="com.i2.ui.web.xsl.xalan.XalanExtension" xmlns:i18n="com.i2.x2.xsl.extensions.i18n.I18NExtension" extension-element-prefixes="i2 i18n" version="1.0">
  ...
  <xsl:template match="RECOVER_PWD_INFO">
...
-->
      <body >
        <FORM NAME="userfm" METHOD="POST" action="{COMMAND/@Value}">
          ...
          <input type="hidden" name="PASSWORD_QUESTION" value="{DESCRIPTION/@Value}"/>
          <table>
            <tr>
              <td>
              ...
              <td valign="top">
                  ...
                  <table border="0" cellPadding="0" cellSpacing="0" width="100%">
                    <tr>
                      ...
                      <td nowrap="yes" width="100%">&#xA0;<b>
                          <i18n:text>
                            <xsl:value-of select="ERR_DESCRIPTION/@Value"/>
                          </i18n:text>
                        </b>
                      </td>
                    </tr>
                ...
                <xsl:if test=" not( ERROR/@Value='false' ) ">
                  <table border="0" cellPadding="2" cellSpacing="5">
                    <tr>
                      <td colspan="5">
                        <span class="TMHead">
                          <br/>
                          <b>
                            <i18n:text>Please enter your Login Name and Password Answer below.</i18n:text>
                          </b>
                        </span>
                      </td>
                    </tr>
                    ...
                    <TR>
                      <TD nowrap="yes">
                        <i18n:text>Login Name</i18n:text>:</TD>
                      <TD>
                        <input type="field" class="inputFieldIE" name="USER_ID" value="{USER_NAME/@Value}" size="30" TABINDEX="5"/>
                      </TD>
                      <td colspan="3"/>
                    </TR>
                    <!-- Password  Question-->
                    <TR>
                      <TD nowrap="yes">
                        <i18n:text>Password Question</i18n:text>:</TD>
                      <TD>
                        <xsl:choose>
			  ...
			  <xsl:otherwise>
				<i18n:text>
					You haven't set your password recovery question and answer yet.
				</i18n:text>
			  </xsl:otherwise>
			</xsl:choose>
                      </TD>
                    ...
                    <TR>
                      <TD nowrap="yes">
                        <i18n:text>Password  Answer</i18n:text>:</TD>
                      <TD>
                        <input type="field" class="inputFieldIE" name="PASSWORD_ANSWER" value="" size="30" TABINDEX="7"/>
                      </TD>
                      <td colspan="3">
                        <i2:button emphasized="yes" onclick="javascript:validate()">
									&#xA0;&#xA0;<i18n:text>Recover Password</i18n:text>&#xA0;&#xA0;
							 </i2:button>
                      </td>
                    </TR>
                    <TR>
