...
<xsl:stylesheet 
  ...
  <xsl:import href="../../../../core/xsl/alert.xsl"/>
  ...
  *********************************************************************** -->      
  <xsl:template match="RESPONSE" mode="content">
    ...
    <table class="messageBoxBackground" width="100%" height="100%">
      ...
      <!-- YES NO Description -->
      <xsl:if test="/RESPONSES/RESPONSE/REQUEST_PARAMETERS/ALERT_TYPE/@Value = 'MDM_CONFIRM'">
      <tr>
        <td  style="padding:8px 16px"/>
        <td width="100%"  style="padding:8px 8px 8px 0px">
               <i18n:text>YES   Update all records on the search</i18n:text>
        </td>
      </tr>
      <tr>
        <td  style="padding:8px 16px"/>
        <td width="100%"  style="padding:8px 8px 8px 0px">
               <i18n:text>NO    Update records on this page only</i18n:text>
        </td>
      </tr>
      </xsl:if>
      <tr>
