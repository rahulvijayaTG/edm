...
<HTML>
  <head>
    ...
    <i2:dhtml padsupport="yes"></i2:dhtml>
  	...
  	document.userfm.USER_ID.focus();
		...
		function cancel(){
  		...
  		function validate()
  		{
  			if (document.userfm.USER_ID.value == "")
  			{
  			...
  			if (document.userfm.PASSWORD_QUESTION.value == "")
  			{
  			// Fix for 512380
  			core_login_alert("Cannot recover password for this user as Password Question is not set");
  			return;
  			}
	
  			if (document.userfm.PASSWORD_ANSWER.value == "")
  			{
				var msg = "Please enter your Password Answer";	
				core_login_alert("Please enter your Password Answer");
  			document.userfm.PASSWORD_ANSWER.focus();
  			return;
  			}
      ...
      function SetfocusSubmit( target ) {
       ...
       function IEEnterKey() {
      	...
      	if( window.event.keyCode == 13 && ((window.event.srcElement.name == "USER_ID") 
							|| (window.event.srcElement.name == "PASSWORD")) )
			{
	...
	<i2:xslt xslfile="$xsl:forgotPasswd"><x2:execute command="bcm.framework.config:getForgotPasswordPage"/></i2:xslt>
<body>
