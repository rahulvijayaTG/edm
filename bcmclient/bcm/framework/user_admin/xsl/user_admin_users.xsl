                        ...
                        <td nowrap="nowrap">
                          <xsl:choose>
                            <xsl:when test="../VIEW_USER_GROUP_DETAILS/@Value = 'yes' ">
                              <a href="javascript:GoToUserGroup()">
...
-->
        ...
        <tr>
          <td>
            <xsl:variable name="caption_title">
              <i18n:text>Messaging Preferences</i18n:text>
            </xsl:variable>
            <i2:container title="{$caption_title}" inner="yes">
              <table border="0" id="WEB_TABLE" cellpadding="0" cellspacing="9" width="100%">
                <tr>
                  <td width="3%">
...
-->
    ...
    <script><![CDATA[
        function GoToUserGroup(){
          document.forms.user_form.action = omxContextPath + '/bcm/framework/user_admin/user_admin_groups_new/goToPage.cmd?WHERE=USER_GROUP_MAIN';
