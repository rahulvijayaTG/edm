...
<html>
  <head>
    <title>MemberHierarchy Child</title>
  </head>
  <body onLoad="onLoad();" onkeypress="IEEnterKey();">

  <i2:xslt xslfile="$xsl:memberHierarchy_child">
    <x2:execute command="bcm.framework.hierarchy.memberHierarchy.memberHierarchyView:load_child"/>
  </i2:xslt>
