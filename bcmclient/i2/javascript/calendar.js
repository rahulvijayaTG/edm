...
//		top.newWin = window.open("../calendar.jsp?mon=" + month + "&day=" + day + "&year=" + year, "cal", "left=490px,top=150px,WIDTH=185,HEIGHT=245");
		top.newWin = window.open(omxContextPath + "/bcm/framework/calendar.jsp?unformattedDate=" + inDate, "cal", "left=490px,top=150px,WIDTH=185,HEIGHT=250");
