...
i2uiPad.lastHighlightedPadItem = null;
i2uiPad.lastHighlightedPadItemName = null;
...
/*
  ...
  Compatibility:  IE, NS4, NS6
*/
function i2uiHighlightPadItem(id)
{
  if (document.layers)
  {
    ...
    if (layer != null)
    {
      if (i2uiPad.lastHighlightedPadItem != null)
      {
        var depth = i2uiPad.lastHighlightedPadItemName.split("_").length;
        if (depth > 2)
          i2uiPad.lastHighlightedPadItem.bgColor = i2uiApplicationPadContent1Bgcolor;
        else
          i2uiPad.lastHighlightedPadItem.bgColor = i2uiApplicationPadContent0Bgcolor;
      }
      layer.bgColor = i2uiApplicationPadHighlightedBgcolor;
      i2uiPad.lastHighlightedPadItem = layer;
      i2uiPad.lastHighlightedPadItemName = id;
    }
  }
  else
  {
    ...
    if (obj != null)
    {
      ...
      if (obj != null)
      {
        if (obj.tagName == 'TR')
        {
          ...
          i2uiPad.lastHighlightedPadItem = obj;
          i2uiPad.lastHighlightedPadItemName = id;
        }
      }
    }
