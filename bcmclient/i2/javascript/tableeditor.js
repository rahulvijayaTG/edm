...
function resizeScrollableTables()
{
  if (!document.layers)
  {
	//  alert("Debuging in sddddddddtttttg");
   ...
   function checkifOneSelected(form)
   {
	  ...
	  if(checkifAnySelected(result_form) == true)
	  {
		...
		else
		{
		  ...
		  document.result_form.DIRECTORY.value = 'bcm.framework.tableeditor';
	...
	function onSaveFilter()
          ...
          function onCreateFavorite()
	  {
	  			document.result_form.target="appFrame";
	  			document.result_form.PAGE.disabled = 'true';
	  			document.result_form.action=omxContextPath+ "/bcm/framework/favorites/createFavorite.jsp";
	  			document.result_form.submit();
	  }
          ...
          function onManageFavorites()
	  {
	  			document.result_form.target="appFrame";
	  			document.result_form.PAGE.disabled = 'true';
	  			document.result_form.action=omxContextPath+ "/bcm/framework/favorites/manageFavorites.jsp";
	  			document.result_form.submit();
	  }
...
function onGenerate()
{
	...
	{
		document.result_form.target="appFrame";
		document.result_form.action=omxContextPath+ "/bcm/framework/hierarchy/timeHierarchy/HorizonRefDetails/getHorizonDetails.cmd";
		displayBusyBox();
		document.result_form.submit();
	}
	else
...
function onDetails()
{
	...
	{
			document.result_form.target="appFrame";
			document.result_form.action=omxContextPath+ "/bcm/framework/hierarchy/timeHierarchy/HorizonRefDetails/getHorizonReferenceDetails.cmd";
			document.result_form.submit();
	}
	else
	{
...
//Merge from TI, for npi member lookups

function onMemberLookup()
{
	disableUnUsedFilterElements();
	document.result_form.target="appFrame";
	document.result_form.action=omxContextPath+ "/bcm/npi/MemberLookupView/showSelectedValue.cmd";
	if(checkifAnySelected(result_form) == false)
	{
		core_alert("PLEASE_SELECT_ATLEAST_ONE_TRANSACTION");
		return;
...
function onMemberLookupCancel()
{
	disableUnUsedFilterElements();
	document.result_form.target="appFrame";
	document.result_form.action=omxContextPath+ "/bcm/npi/MemberLookupView/cancel.cmd";
	document.result_form.submit();
}