    ...
    function setToday() {
      ...
      document.location.href = "calendar.jsp?mon=" + month + "&day=" + day + "&year=" + year;
    }
  ...
  function onDblClickDate(day)
{
    ...
    document.location.href = "calendar.jsp?close=true&mon=" + month + "&day=" + day + "&year=" + year;
  }
  ...
  // SET FIELD VALUE TO THE DATE SELECTED AND CLOSE THE CALENDAR WINDOW
   ...
   var formatDateTime = document.calControl.formattedDateTime.value;
   ...
   if(fieldName.search(/_DT/) == fieldName.length-3)
   {
     f.value = formatDateTime;
   }
   else
   {
      f.value = formatDate;
